...
export const dictionaries = {
  en: {
    ...
    auth: {
      ...
      resetLinkInvalid: "This reset link is invalid. Please request a new one from the forgot password page.",
      passwordResetSuccess: "Your password has been updated. You can sign in now.",
      emailVerifiedSuccess: "Your email has been verified. You can sign in now.",
      verifyLinkInvalid: "This verification link is invalid or has expired.",
      verifyEmailTitle: "Verify your email",
      verifyEmailPrompt: "Check your inbox for a verification link to unlock all account features.",
      verifyEmailSent: "We sent a verification email. Check your inbox and click the link to verify.",
  ...
  zh: {
    ...
    auth: {
      ...
      newPassword: "新密码",
      setNewPassword: "更新密码",
      resetLinkInvalid: "此重置链接无效。请从忘记密码页面重新申请。",
      passwordResetSuccess: "密码已更新，您现在可以登录。",
      emailVerifiedSuccess: "邮箱已验证，您现在可以登录。",
      verifyLinkInvalid: "此验证链接无效或已过期。",
      verifyEmailTitle: "验证您的邮箱",
      verifyEmailPrompt: "请查收验证邮件并点击链接以启用全部账户功能。",
      verifyEmailSent: "我们已发送验证邮件，请查收并点击链接完成验证。",
